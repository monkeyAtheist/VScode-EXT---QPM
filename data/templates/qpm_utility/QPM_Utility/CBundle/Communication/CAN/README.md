...
Unsupported platforms return `QPM_CAN_ERROR_UNSUPPORTED` by default. For Windows CAN adapters, prefer adding a thin adapter around the vendor SDK, because PCAN, Kvaser, NI-XNET and Vector XL use different APIs.
