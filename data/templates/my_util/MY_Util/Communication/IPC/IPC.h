...
namespace jc_ipc {
    ...
    enum class PipeType {
        ...
        Fifo,       // Linux: paire de FIFO nomm�es pour full-duplex
    ...
    struct IpcConfig {
        ...
        bool messageMode = true; // utile surtout c�t� Windows Named Pipe
    };
    ...
    public:
        ...
        // Cr�e une paire de pipes anonymes unidirectionnelle.
        // reader  : endpoint lecture seule
        // writer  : endpoint �criture seule
    ...
    private:
        ...
        handle_t controlHandle_ = kInvalidHandle; // serveur/listen si n�cessaire
