...
namespace jc_wifi {
    ...
    public:
        ...
        // UDP uniquement : �mission/r�ception avec endpoint explicite
        ...
        // Format de trame coh�rent avec l'UART :
    ...
    private:
        ...
        socket_handle_t peerSocket_ = kInvalidSocket;  // client accept� TCP serveur
        bool opened_ = false;
