...
function generateQmakeProject(context) {
    ...
    const needsWindowsResource = process.platform === 'win32' && context.manifest.kind !== 'static-library' && (includeWindowsMetadata || !!(0, qtProjectManifest_1.executableIconPath)(context.manifest));
    const windowsBuildResource = needsWindowsResource
        ? (0, qpmQtPackagingModel_1.writeQtWindowsBuildResource)(context.manifestPath, context.manifest, includeWindowsMetadata)
        : undefined;
