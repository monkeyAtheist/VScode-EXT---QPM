...
async function activate(context) {
    ...
    const builds = new qpmBuildService_1.QpmBuildService(parser, workspaces, qtInstallations, projectSettings, undefined, output, qtPython, qtDependencies);
