...
async function activate(context) {
    ...
    const builds = new qpmBuildService_1.QpmBuildService(parser, workspaces, qtInstallations, projectSettings, undefined, output);
    ...
    context.subscriptions.push(output, workspaces, home, buildSettings, qtProjectSettings, sdl, quickActions, quickActionsRegistration, cppTools, qtTools, qtKits, qtKitsProvider, qtKitsView, debugging, qtDebugProvider, qtDebugView, platforms, qtPlatformProvider, qtPlatformView, packaging, qtPackagingView, installers, qtInstallerProvider, qtInstallerView, publication, qtPublicationProvider, qtPublicationView, profiling, qtProfilingProvider, qtProfilingView, android, apple, qmlLanguage, qmlLanguageProvider, qmlLanguageView, qtAndroidProvider, qtAndroidView, qtAppleProvider, qtAppleView, vscode.debug.registerDebugConfigurationProvider('cppdbg', { provideDebugConfigurations: () => debugging.provideDebugConfigurationsForType('cppdbg') }, vscode.DebugConfigurationProviderTriggerKind.Dynamic), vscode.debug.registerDebugConfigurationProvider('cppvsdbg', { provideDebugConfigurations: () => debugging.provideDebugConfigurationsForType('cppvsdbg') }, vscode.DebugConfigurationProviderTriggerKind.Dynamic), vscode.debug.registerDebugConfigurationProvider('qml', { provideDebugConfigurations: () => debugging.provideDebugConfigurationsForType('qml') }, vscode.DebugConfigurationProviderTriggerKind.Dynamic), qtToolsProvider, qtToolsView, quality, testing, qtQualityProvider, qtQualityView, treeView, fileSymbolsView, projectHealthProvider, projectHealthView, completionRegistration, ...statusBarItems, treeView.onDidChangeSelection((event) => {
    ...
    }), register('qpm.createNewFile', (node) => {
        if (node?.kind === 'folder') {
