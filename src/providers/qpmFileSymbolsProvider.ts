...
import { QpmSourceSymbol, QpmSymbolService, isSourceOrHeader } from '../services/qpmSymbolService';

type FileSymbolNode = QpmSourceSymbol | { kind: 'placeholder'; label: string };

export class QpmFileSymbolsProvider implements vscode.TreeDataProvider<FileSymbolNode> {
  ...
  async reveal(symbol: QpmSourceSymbol): Promise<void> {
