...
export class QpmEditorUtilitiesService {
  async openCharacterTable(): Promise<void> { await openCharacterTable(undefined); }
  async convertSelectedTextToDecimalValues(): Promise<void> { await convertSelectedTextToDecimalValues(); }
  async convertSelectedNumbersToText(): Promise<void> { await convertSelectedNumbersToText(); }
  async openNumberConverter(): Promise<void> { await openNumberConverter(undefined); }
  async openTruthTableDesigner(): Promise<void> { await openTruthTableDesigner(undefined); }
  async openDigitalFilterDesigner(): Promise<void> { await openDigitalFilterDesigner(undefined); }
}
