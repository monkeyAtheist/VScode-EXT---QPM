...
export class QpmQtProjectService {
  ...
  async openDesigner(input?: unknown): Promise<void> {
...
function designerEnvironment(installation: QpmQtInstallation): NodeJS.ProcessEnv {
...
async function spawnDesigner(installation: QpmQtInstallation, target: string, output: vscode.OutputChannel): Promise<void> {
